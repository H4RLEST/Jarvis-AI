...
class Jarvis(widget.Widget):
    def __init__(self, **kwargs):
        ...
        self.subtitles_input = textinput.TextInput(
            text='Hey Dhruv! Soy tu asistente personal echo por harlest',
            font_size=24,
            readonly=False,
    ...
    def handle_jarvis_commands(self,query):  
        try:
            ...
            elif "abrir el símbolo del sistema" in query:

                speak("Opening command prompt")
                os.system('start cmd')

            elif "abrir la cámara" in query:

                speak("Opening camera sir")
                sp.run('start microsoft.windows.camera:', shell=True)

            elif "abrir el bloc de notas" in query:
            ...
            elif "enviar un correo electrónico" in query:
            ...
            elif "dime las noticias" in query:
